...
|10 | [数据源管理：分布式NoSQL系统，Cassandra集群管理](https://mp.weixin.qq.com/s/LffhFui3YfouUAxPL_rCsg)|[GitHub](https://github.com/cicadasmile/data-manage-parent/tree/master/heap01-data-source/case10-cassand-cluster)|

### 数据分析

|序号| 标题 | 源码 |
|:---|:---|:---|
|01 | [数据分析：基于智能标签，精准管理数据](https://mp.weixin.qq.com/s/Tg_AirB-ewWym6MOhRkwjw)|[GitHub](https://github.com/cicadasmile/data-manage-parent/tree/master/heap02-data-analy/case01-smart-tag)|
|02 | [数据分析：数据可视化图表，BI工具构建逻辑](https://mp.weixin.qq.com/s/W86TbvYD_i9h23ZSNeh1Ag)|[GitHub](https://github.com/cicadasmile/data-manage-parent/tree/master/heap02-data-analy/case02-visual-chart)|
...
|序号| 标题| 源码 |
|:---|:---|:---|
|01 | [开发工具：Mybatis.Plus.插件三种方式的逆向工程](https://mp.weixin.qq.com/s/IGcSMw3lmcOSTS-8a-AVGw)|[GitHub](https://github.com/cicadasmile/data-manage-parent/tree/master/heap04-format-tool/case01-generator-code)|
|02 | [编码风格：Mvc模式下SSM环境，代码分层管理](https://mp.weixin.qq.com/s/O4w4ojM-RFqikTW-N2nleQ)|[GitHub](https://github.com/cicadasmile/data-manage-parent/tree/master/heap04-format-tool/case02-mvc-style)|
